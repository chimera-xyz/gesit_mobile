...
class ChatHubScreen extends StatefulWidget {
  const ChatHubScreen({super.key, required this.onOpenConversation});
...
class _ChatHubScreenState extends State<ChatHubScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final pinned = DemoData.conversations
        .where((conversation) => conversation.isPinned)
        .toList();
    final query = _searchController.text.trim().toLowerCase();
    final filtered = DemoData.conversations.where((conversation) {
          ...
          Wrap(
            ...
            children: [
              ...
              FilterPill(
                ...
                onTap: () => setState(() => _selectedFilter = 'Belum Dibaca'),
              ),
              FilterPill(
                label: 'Grup',
